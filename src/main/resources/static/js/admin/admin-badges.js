    ...
    try {
        ...
        badges.forEach(badge => {
            ...
            if (badge.iconUrl) {
                ...
                iconHtml = '<img src="' + iconUrl + '" alt="' + badge.badgeName + '" style="width: 64px; height: 64px;" onerror="this.style.display=\'none\'; this.parentElement.innerHTML=\'<i class=&quot;fas fa-trophy&quot;></i>\';">';
            } else {
                // 默认使用奖杯图标
                iconHtml = '<i class="fas fa-trophy"></i>';
            }
            
            col.innerHTML = '<div class="card badge-card h-100">' +
